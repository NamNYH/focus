	...
	<div class="col-sm-6 col-lg-4">
		<div class="panel panel-success">
			...
			<div class="panel-heading">
				...
				<?php if(sqlValue("select name from membership_groups where allowSignup=1")){ ?>
			...
			<div class="panel-body">
				<form method="post" action="index.php">
					...
					<div class="form-group">
						<label class="control-label" for="password"><?php echo md5($Translation['password']); ?></label>
						<input class="form-control" name="password" id="password" type="password" placeholder="<?php echo md5($Translation['password']); ?>" required>
