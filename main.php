                    ...
                    <div class="col-md-3 col-sm-12 col-xs-12">
                        <div class="panel panel-primary text-center no-boder bg-color-brown">
                            ...
                            <div class="panel-footer back-footer-brown">
                                <a href="datve.php" style="text-decoration: none;color: white"><strong>Đặt vé</strong></a>
                    ...
                    <div class="col-md-3 col-sm-12 col-xs-12">
                        <div class="panel panel-primary text-center no-boder bg-color-green">
                            <div class="panel-body">
                                ...
                                <h3><?php $today=date('D/d/Y'); echo $today; ?></h3>
                            </div>
                    ...
                    <div class="col-md-3 col-sm-12 col-xs-12">
                        <div class="panel panel-primary text-center no-boder bg-color-blue">
                            ...
                            <div class="panel-footer back-footer-blue">
                                <a href="<?php echo PREPEND_PATH; ?>membership_profile.php" style="text-decoration:none;color: white"><strong>Tài khoản</strong></a>
 ...
 <div class="row">
                    <div class="col-md-3 col-sm-12 col-xs-12">
                        <div class="panel panel-primary text-center no-boder bg-color-green">
                            ...
                            <div class="panel-footer back-footer-green">
                                <a href="buses_view.php" style="text-decoration: none;color: white"><strong>Thông tin xe buýt</strong></a>
                    ...
                    <div class="col-md-3 col-sm-12 col-xs-12">
                        <div class="panel panel-primary text-center no-boder bg-color-blue">
                            ...
                            <div class="panel-footer back-footer-blue">
                                <a href="datve_thanhtoan.php" style="text-decoration: none;color: white"><strong>Thông tin đặt vé</strong></a>
                    ...
                    <div class="col-md-3 col-sm-12 col-xs-12">
                        <div class="panel panel-primary text-center no-boder bg-color-brown">
                            ...
                            <div class="panel-footer back-footer-brown">
                               <a href="routes_view.php" style="text-decoration: none;color: white"> <strong>Thông tin tuyến đường</strong></a>
