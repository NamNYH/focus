        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="gioithieu.php"><i class="fa fa-dashboard"></i> Giới thiệu</a>
                    </li>
                    <li>
                        <a href="chucvu.php"><i class="fa fa-cog"></i> Quản lý chức vụ</a>
                    </li>
                    <li>
                        <a href="danhsachtk.php"><i class="fa fa-cog"></i>  Quản lý nhân viên</a>
                    </li>
                    <li>
                        <a href="customers_view.php"><i class="fa fa-users"></i>Quản lý thông tin khách hàng</a>
                    </li>
					 <!--/<li>
                        <a href="bookings_view.php"><i class="fa fa-money"></i>Đặt vé</a>
                    </li>-->
                    <li>
                        <a href="buses_view.php"><i class="fa fa-truck"></i>Quản lý xe buýt</a>
                    </li>
                    
                    <li>
                        <a href="datve_view.php"><i class="fa fa-sitemap"></i>Quản lý hóa đơn vé</a>
                    </li>

                    <li>
                        <a href=""><i class="fa fa-check-circle"></i>Quản lý tài khoản</a>
                    </li>
                    <li>
                        <a href="routes_view.php"><i class="fa fa-road"></i> Quản lý tuyến đường</a>
                    </li>
              
                    <li>
                        <a href="doanhthu.php"><i class="fa fa-check-circle"></i>Doanh thu</a>
                    </li>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
			 <div class="row">
                 ...
                 <!-- /. ROW  -->
				 <footer><strong><p><center>Ebus được phát triển bởi: KIET</p></center></strong></footer>
				</div>
             <!-- /. PAGE INNER  -->
            </div>
         <!-- /. PAGE WRAPPER  -->
