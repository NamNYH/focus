...
$result = $con ->query("SELECT name, email, sdt, Giave FROM datve");
?>
...
Thanh toán trực tuyến bằng thẻ ATM; Visa, Master Card;... qua NgânLượng.vn</span></p>
	...
	<table>
		<tr><th><strong>Họ Tên:</strong></th><td><input  type="text" name="txh_name" size="28" value="" /></td></tr>
		<tr><th><strong>Email:</strong></th><td><input  type="text" name="txt_email" size="28" value="" /></td></tr>
		<tr><th><strong>Số điện thoại:</strong></th><td><input  type="text" name="txt_phone" size="28" value="" /></td></tr>
		<tr><th><strong>Số tiền thanh toán:</strong></th><td><input name="txt_gia" type="text" size="28" value="" /></td></tr>	
