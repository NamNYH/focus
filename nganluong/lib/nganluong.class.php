...
class NL_Checkout 
{
	...
	public $nganluong_url = 'http://busbooking.com';	
	// Mã website của bạn đăng ký trong chức năng tích hợp thanh toán của NgânLượng.vn.
	public $merchant_site_code = '64255'; //100001 chỉ là ví dụ, bạn hãy thay bằng mã của bạn
	// Mật khẩu giao tiếp giữa website của bạn và NgânLượng.vn.
	public $secure_pass= 'c46e5fb742e5eb63a687d64b727cc80a'; //d685739bf1 chỉ là ví dụ, bạn hãy thay bằng mật khẩu của bạn
