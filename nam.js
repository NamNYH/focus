window.pageMapVehicleTracking = function ()
{
    ...
    L.tileLayer(myUrl, { maxZoom: 40, attribution: 'Code mô ph?ng © <a href="http://sonpc20.com">Sonpc20.com</a>', id: 'mapbox/streets-v11', tileSize: 512, zoomOffset: -1 }).addTo(mapView.map);
